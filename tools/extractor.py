...
exists so the process can be run end to end today, and it is a useful baseline to hold that
against: it reads all 471 text-layer invoices of the challenge and none of the 29 scans.
