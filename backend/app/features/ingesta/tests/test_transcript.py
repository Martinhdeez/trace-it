...
def test_remote_fragmented_headings_keep_raw_and_remain_unverified():
    text = "N IF: B 98120774 I BAN: ES 44 1465 0100 9517 0430 2211 Fec ha: 22/03/2026 Base im poni ble 640,00 IV A 21% 134,40 TOTAL 774,40 EUR"
    ...
    assert all(fields[k].status == "UNVERIFIED" for k in ("supplier_tax_id", "payment_iban", "gross_amount"))
