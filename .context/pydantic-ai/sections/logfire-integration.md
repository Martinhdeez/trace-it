...
![Logfire Evals Overview](https://pydantic.dev/docs/ai/img/logfire-evals-overview.png)
...
![Logfire Evals Case](https://pydantic.dev/docs/ai/img/logfire-evals-case.png)

### Full Trace View

View the complete execution trace including all spans generated during evaluation:

![Logfire Evals Case Trace](https://pydantic.dev/docs/ai/img/logfire-evals-case-trace.png)
