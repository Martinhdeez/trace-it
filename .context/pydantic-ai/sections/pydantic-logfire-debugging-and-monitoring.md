...
![Weather Agent Logfire](https://pydantic.dev/docs/ai/img/logfire-weather-agent.png)
...
![Logfire Simple Agent Run](https://pydantic.dev/docs/ai/img/logfire-simple-agent.png)
...
![Logfire monitoring Pydantic AI](https://pydantic.dev/docs/ai/img/logfire-monitoring-pydanticai.png)
...
![Logfire with HTTPX instrumentation](https://pydantic.dev/docs/ai/img/logfire-with-httpx.png)
...
![otel tui simple](https://pydantic.dev/docs/ai/img/otel-tui-simple.png)
...
![otel tui weather agent](https://pydantic.dev/docs/ai/img/otel-tui-weather.png)
