...
| [0026](0026-ocr-execution-modes-and-provider-fallback.md) | Configure local/API/hybrid OCR and bounded provider fallback | proposed | Preserve the invoice default; distinct visual corroboration, Helmcode fallback, network-only usage, latency and explicit billing basis |
