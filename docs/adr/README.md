...
| ![B](https://img.shields.io/badge/-B-d97706?style=for-the-badge) | [When in doubt, ESCALAR](B-when-in-doubt-escalate.md) | Quality of execution (10) | One decision per file: 436 `PAGAR` / 36 `NO_PAGAR` / 28 `ESCALAR` in the delivered `outcomes.jsonl`, each escalation with its reason code |
...
<details>
<summary>Supporting ADRs (37)</summary>
...
| [0038](detail/0038-exchange-rates-are-a-source-of-truth.md) | Keep exchange rates a source of truth, not something a rule looks up | accepted | B, E |
