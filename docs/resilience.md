...
1. **A failed compile no longer escalates.** ADR 0004 §7, ADR 0016, ADR 0020 ("Done") and
   ...
   every instance with `RULE_COMPILE_FAILED`. That was #64. Then #66 (ADR 0022, manager
   ...
   deciding and the new check waits. ADR 0022 records this as intended ("replaces ADR 0020's
