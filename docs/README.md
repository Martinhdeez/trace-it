...
| [integration.md](integration.md) | Frontend-backend reconciliation: direction per feature, shared vocabulary, open questions, work order ([detailed plan](integration-plan.md)) |
| [backend-plan.md](backend-plan.md) | The remaining backend work for the integration: items, waves and open decisions |
...
| [../processes/hiring-screening/README.md](../processes/hiring-screening/README.md) | A second problem born on stage: CVs, a messy policy and a workbook go through discovery; `make hiring-demo` writes the evaluation report |
