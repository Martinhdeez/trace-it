...
| `make e2e-integration` | The demo path through the real console and API in Chromium, on a fresh `trace_e2e_test` database with the frozen pack; no LLM key (`tests/integration/README.md`). Run before every PR that touches the console or the API |
